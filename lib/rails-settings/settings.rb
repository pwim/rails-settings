class Settings < ActiveRecord::Base
  ...
  def self.retrieve_hash(starting_with=nil)
    var_scope = target_scoped.select('var, value')
    var_scope.where!("var LIKE '#{starting_with}%'") if starting_with

    result = {}
    var_scope.load.each do |record|
